...
public class TERenderer {
     ...
     */
    public void renderFrame(TETile[][] world, HUD hud) {
        ...
        hud.hoveredTile();
        hud.displayDateTime();
        hud.displayHoverTile();
        StdDraw.show();
    }
    public void renderFrame(TETile[][] world, HUD hud, Integer xStart, Integer yStart, Integer xEnd, Integer yEnd) {
        int numXTiles = world.length;
        int numYTiles = world[0].length;
        StdDraw.clear(new Color(0, 0, 0));
